...
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[35] }]; #IO_L11P_T1_SRCC_15 Sch=ja[10]

## Pmod Header JB
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[22] }]; #IO_L12P_T1_MRCC_15 Sch=jb[1]
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[31] }]; #IO_L12N_T1_MRCC_15 Sch=jb[2]
# set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[33] }]; #IO_L22N_T3_A16_15 Sch=jb[3]
# set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[34] }]; #IO_L23P_T3_FOE_B_15 Sch=jb[4]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[35] }]; #IO_L23N_T3_FWE_B_15 Sch=jb[7]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[36] }]; #IO_L24P_T3_RS1_15 Sch=jb[8]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[37] }]; #IO_L24N_T3_RS0_15 Sch=jb[9]
# set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[38] }]; #IO_25_15 Sch=jb[10]
...
# mprj_io[16:19] are routed to Pmod JC for the encoder.
# set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[16] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=ck_io[26]
# set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[17] }]; #IO_L16N_T2_A15_D31_14 Sch=ck_io[27]
# set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[18] }]; #IO_L6N_T0_D08_VREF_14 Sch=ck_io[28]
# set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[19] }]; #IO_25_14 Sch=ck_io[29]
